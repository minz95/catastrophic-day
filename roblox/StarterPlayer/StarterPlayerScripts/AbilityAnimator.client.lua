...
local EFFECT_ANIMS = {
	...
	soundBlast      = { "BLAST!",    Color3.fromRGB(255, 180, 60),  "shake",   Color3.fromRGB(255, 160, 40),  Color3.fromRGB(255, 180, 60),  25, 30 },
	bubbleShield    = { "SHIELD!",   Color3.fromRGB(150, 220, 255), "bounce",  Color3.fromRGB(130, 210, 255), Color3.fromRGB(150, 220, 255), 25, 15 },
